...
export default function Hero() {
  ...
  const cardGlow = 'var(--card-glow-color, rgba(59,158,255,0.60))';
  const cardInnerGradient = 'var(--card-inner-gradient, linear-gradient(145deg,#60496e8c 0%,#71C4FF44 100%))';
